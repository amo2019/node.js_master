  ...
  if (typeof tokenString == "string") {
    try {
      ...
      if (typeof token == "object") {
        app.setLoggedInClass(true);
        //document.getElementById("cta_green").style.visibility = "hidden";
        //document.getElementById("cta_blue").style.visibility = "hidden";
      } else {
        var element = document.getElementById("cta_green");
        element.classList.remove("ctaStatus");
        app.setLoggedInClass(false);
        element = document.getElementById("cta_blue");
        element.classList.remove("ctaStatus");
        //document.getElementById("cta_green").style.visibility = "visible";
        //document.getElementById("cta_blue").style.visibility = "visible";
