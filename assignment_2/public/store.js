...
var stripeHandler = StripeCheckout.configure({
  ...
  token: function (token) {
    ...
    console.log("itemsToBuy (store.js):", itemsToBuy);
...
function fetchData(callback) {
  ...
  fetch(req)
    ...
    .then((content) => {
      ...
      if (content) {
        //it worked
        console.log("Data Fetched..: ", content.data);
...
function saveClicked() {
  ...
  console.log("itemsToBuy...", dataString);
  try {
    var data = JSON.parse(dataString);
    console.log("data...", data);
    if (data.itemsToBuy) {
      console.log("itemsToBuy...", data.itemsToBuy);
